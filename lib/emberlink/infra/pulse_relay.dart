...
Future<void> ridgeBackgroundMessage(RemoteMessage _) async {}

/// Firebase Messaging + APNs plumbing: token warm-up, foreground presentation,
/// push-URL capture and the notification-permission request.
class PulseRelay {
  ...
  Future<void> _boot() async {
    ...
    FirebaseMessaging.onBackgroundMessage(ridgeBackgroundMessage);
